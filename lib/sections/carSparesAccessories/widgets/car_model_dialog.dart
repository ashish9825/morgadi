...
import '../data/spares_provider.dart';
import 'package:morgadi/sections/carSparesAccessories/bloc/spares.dart';
import 'package:morgadi/utils/size_config.dart';

class CarModelDialog extends StatelessWidget {
  final String carBrand;
  final SparesBloc sparesBloc;
  CarModelDialog({@required this.carBrand, @required this.sparesBloc});

  SparesProvider _provider = SparesProvider();
  ...
  Widget _modelsBody(BuildContext context) {
    return StreamBuilder(
      stream: sparesBloc.internetStream,
