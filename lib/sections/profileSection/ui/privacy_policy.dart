...
class PrivacyPolicy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _privacyPolicyBody(context),
    );
  }

  Widget _privacyPolicyBody(BuildContext ctx) {
    return Padding(
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<DocumentSnapshot>(
              stream: _profileRepository.fetchPrivacyPolicy(),
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  return _privacyList(snapshot.data.get('data'), ctx);
  ...
  Widget _privacyList(String privacyPolicyData, BuildContext ctx) {
    return ListView(
      children: [
        Html(
