...
class TermsAndConditions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _termsAndConditionsBody(context),
    );
  }

  Widget _termsAndConditionsBody(BuildContext ctx) {
    return Padding(
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<DocumentSnapshot>(
              stream: _profileRepository.fetchTermsAndConditions(),
  ...
  Widget _termsAndConditions(String aboutMorgadiData, BuildContext ctx) {
    return ListView(
      children: [
        Html(
          data: aboutMorgadiData,
          onLinkTap: (url) {
