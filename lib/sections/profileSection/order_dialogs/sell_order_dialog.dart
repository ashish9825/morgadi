...
class SellOrderDialog extends StatelessWidget {
  SellOrderDialog(this.doc);
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(
                    text:
                        'A interest was shown by you to sell ${doc.get('car')} ${doc.get('model')} having registration number as ',
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ),
                  TextSpan(
                      text: '${doc.get('regNo')}',
