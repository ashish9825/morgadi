...
class BuyOrderDialog extends StatelessWidget {
  BuyOrderDialog(this.doc);
            ...
            child: RichText(
              text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(
                        text:
                            'A interest was shown by you to buy ${doc.get('car')} ${doc.get('model')} which can be from years ',
                        style: TextStyle(fontWeight: FontWeight.w500)),
                    TextSpan(
                        text: '${doc.get('originYearRange')}',
