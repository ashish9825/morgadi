...
class MortgageOrderDialog extends StatelessWidget {
  MortgageOrderDialog(this.doc);
          ...
          Center(
            child: RichText(
              text: TextSpan(
                ...
                children: <TextSpan>[
                  TextSpan(
                    text: 'You have requested a mortgage of ',
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ),
                  TextSpan(
                      text: '₹ ${doc.get('amount')} ',
                  ...
                  TextSpan(
                    text:
                        'on ${doc.get('car')} ${doc.get('model')} bearing registration number ',
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ),
                  TextSpan(
                    text: '${doc.get('regNo')}',
                  ...
                  TextSpan(
                    text: ' and origin year being ',
                    style: TextStyle(fontWeight: FontWeight.w500),
                  ),
                  TextSpan(
                    text: '${doc.get('originYear')}',
                    style: TextStyle(fontWeight: FontWeight.w700),
                  ),
                  TextSpan(
                    text: '.',
