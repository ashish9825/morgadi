...
class EditMailDialog extends StatelessWidget {
  final EditProfileBloc editProfileBloc;
  final String email;

  EditMailDialog({this.editProfileBloc, this.email});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => editProfileBloc,
      child: EditMailConfirm(editProfileBloc: editProfileBloc, email: email),
    );
  }
}

class EditMailConfirm extends StatelessWidget {
  final EditProfileBloc editProfileBloc;
  final String email;

  EditMailConfirm({this.editProfileBloc, this.email});
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: BlocListener<EditProfileBloc, EditProfileState>(
        ...
        listener: (context, editMailState) {
          if (editMailState is EditExceptionState) {
            String message;
            message = editMailState.message;
  ...
  getViewAsPerState(EditProfileState state, BuildContext context) {
    ...
    } else if (state is EditMailCompletedState) {
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    editProfileBloc.add(
                      EditMailEvent(mailController.text),
                    );
                  },
                  child: Container(
