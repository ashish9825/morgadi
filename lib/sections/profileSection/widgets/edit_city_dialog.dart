...
class EditCityDialog extends StatelessWidget {
  ...
  EditCityDialog({this.editProfileBloc, this.city});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => editProfileBloc,
      child: EditCityConfirm(
...
class EditCityConfirm extends StatelessWidget {
  final EditProfileBloc editProfileBloc;
  final String city;

  EditCityConfirm({this.editProfileBloc, this.city});
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: BlocListener<EditProfileBloc, EditProfileState>(
        ...
        listener: (context, editCityState) {
          if (editCityState is EditExceptionState) {
            String message;
            message = editCityState.message;
  ...
  getViewAsPerState(EditProfileState state, BuildContext context) {
    ...
    } else if (state is EditCityCompletedState) {
            ...
            child: Row(
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    editProfileBloc.add(
                      EditCityEvent(cityController.text),
                    );
                  },
                  child: Container(
